...
<head>
    ...
    <title>Beauty &amp; Health — PointSales</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-section" style="margin-top:.5rem;">
            ...
            <a href="/category/beauty-health" class="nav-item active"><span class="ico">💄</span> Beauty &amp;
                Health</a>
    ...
    <div class="topbar">
        <div class="topbar-left">
            <h2>💄 Beauty &amp; Health</h2>
            <p>Manajemen produk kecantikan dan kesehatan</p>
        </div>
    ...
    <main class="main">
        <div class="content">
            <div class="breadcrumb fade">
                <a href="/"><i class="fa-solid fa-chart-pie"></i> Dashboard</a><i
                    class="fa-solid fa-chevron-right"></i><span>Kategori</span><i
                    class="fa-solid fa-chevron-right"></i><span>Beauty &amp; Health</span>
            </div>
            <div class="page-h fade">
                <div class="page-h-left">
                    <h1>💄 Beauty &amp; Health</h1>
                    <p>Produk kecantikan, perawatan kulit, dan kesehatan pribadi berkualitas.</p>
                    <div class="page-h-badges">
                        <span class="badge"><span class="dot"></span> Stok Aktif</span>
                        <span class="badge"><i class="fa-solid fa-boxes-stacked"></i> 85 SKU</span>
        ...
        <footer>
            <p>© 2026 <strong style="color:var(--ts);">Athaulla Hafizh</strong> · PointSales POS System · Kategori
                Beauty &amp; Health</p>
    ...
    <script>
        const PRODS = [
            { id: 'BH001', name: 'Handbody Vaseline', desc: '200ml · Pelembab Kulit', price: 28000, emoji: '🧴', stock: 45, cat: 'Perawatan' },
            { id: 'BH002', name: 'Pepsodent 190gr', desc: '190gr · Pasta Gigi', price: 15500, emoji: '🪥', stock: 70, cat: 'Gigi' },
            { id: 'BH003', name: 'Sabun Lifebuoy', desc: '110gr · Sabun Mandi', price: 7000, emoji: '🧼', stock: 80, cat: 'Sabun' },
            { id: 'BH004', name: 'Tolak Angin', desc: '15ml · Obat Herbal', price: 3500, emoji: '🌿', stock: 150, cat: 'Kesehatan' },
            { id: 'BH005', name: 'Paracetamol 500mg', desc: '10 tablet · Analgesik', price: 5000, emoji: '💊', stock: 200, cat: 'Obat' },
            { id: 'BH006', name: "Pond's White Beauty", desc: '50gr · Krim Wajah', price: 22000, emoji: '🧽', stock: 12, cat: 'Wajah' },
            { id: 'BH007', name: 'Shampoo Clear Men', desc: '170ml · Sampo Anti Ketombe', price: 19000, emoji: '🫧', stock: 50, cat: 'Rambut' },
            { id: 'BH008', name: 'Hansaplast Plester', desc: '10pcs · P3K', price: 9500, emoji: '🩹', stock: 120, cat: 'P3K' },
        ];
