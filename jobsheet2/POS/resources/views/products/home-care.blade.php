...
<head>
    ...
    <title>Home Care — PointSales</title>
...
<body>
    <aside class="sidebar">
        ...
        <div class="sidebar-section" style="margin-top:.5rem;">
            ...
            <a href="/category/home-care" class="nav-item active"><span class="ico">🏠</span> Home Care</a>
    ...
    <div class="topbar">
        <div class="topbar-left">
            <h2>🏠 Home Care</h2>
            <p>Manajemen produk perlengkapan rumah tangga</p>
        </div>
    ...
    <main class="main">
        <div class="content">
            <div class="breadcrumb fade"><a href="/"><i class="fa-solid fa-chart-pie"></i> Dashboard</a><i
                    ...
                    class="fa-solid fa-chevron-right"></i><span>Home Care</span></div>
            <div class="page-h fade">
                <div class="page-h-left">
                    <h1>🏠 Home Care</h1>
                    <p>Perlengkapan rumah tangga dan produk kebersihan untuk kenyamanan hunian Anda.</p>
                    <div class="page-h-badges">
                        <span class="badge"><span class="dot"></span> Stok Aktif</span>
                        <span class="badge"><i class="fa-solid fa-boxes-stacked"></i> 95 SKU</span>
        ...
        <footer>
            <p>© 2026 <strong style="color:var(--ts);">Athaulla Hafizh</strong> · PointSales POS System · Kategori Home
                Care</p><a href="/" style="font-size:.72rem;color:var(--tm);" onmouseover="this.style.color='#808080'"
    ...
    <script>
        const PRODS = [
            { id: 'HC001', name: 'Sapu Lantai Premium', desc: '1 pcs · Perlengkapan Rumah', price: 35000, emoji: '🧹', stock: 20, cat: 'Kebersihan' },
            { id: 'HC002', name: 'Rinso Anti Noda', desc: '900gr · Deterjen Bubuk', price: 22500, emoji: '🫧', stock: 55, cat: 'Deterjen' },
            { id: 'HC003', name: 'Sunlight Jeruk', desc: '755ml · Sabun Cuci Piring', price: 16000, emoji: '✨', stock: 65, cat: 'Pembersih' },
            { id: 'HC004', name: 'Wipol Pembersih Lantai', desc: '770ml · Pembersih Lantai', price: 18000, emoji: '🚿', stock: 40, cat: 'Lantai' },
            { id: 'HC005', name: 'Bayclin Pemutih', desc: '500ml · Pemutih Pakaian', price: 12000, emoji: '🪣', stock: 10, cat: 'Kebersihan' },
            { id: 'HC006', name: 'Glade Pengharum', desc: '70gr · Pengharum Ruangan', price: 25000, emoji: '🪴', stock: 35, cat: 'Pengharum' },
            { id: 'HC007', name: 'Kaca Pembersih Glass', desc: '500ml · Pembersih Kaca', price: 14500, emoji: '🪟', stock: 42, cat: 'Pembersih' },
            { id: 'HC008', name: 'Baygon Semprot', desc: '600ml · Insektisida', price: 32000, emoji: '🐛', stock: 8, cat: 'Insektisida' },
        ];
        ...
        (function () {
            try {
                ...
                PRODS.forEach(p => { if (saved[p.id] !== undefined) { p.stock = saved[p.id]; currentData = [...PRODS]; } });
            } catch (e) { }
        })();
